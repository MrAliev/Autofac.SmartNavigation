...
using WpfNetCore.Commands;
using WpfNetCore.Interfaces;

namespace WpfNetCore.ViewModels
{
    public class SecondWindowViewModel : BaseVM
    {
        ...
        public string Title { get; } = "Окно без страничной навигации";
        public string ViewModelName { get; } = nameof(SecondWindowViewModel);
        ...
        public SecondWindowViewModel(IDataService data, INavigationService navigation)
        {
            _data = data;
